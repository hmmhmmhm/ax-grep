...
JSON-LD and OpenSearch action endpoints. `pageCheck.appHints` captures web app
manifest, icon, theme, and installability metadata. `pageCheck.keyValues` captures compact

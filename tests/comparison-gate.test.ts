...
function staticSummary(overrides: Partial<StaticGateSummary> = {}): StaticGateSummary {
  return {
    ...
    averagePageCheckUrlItemPathScore: 1,
    averagePageCheckFormUrlPathScore: 1,
    averagePageCheckActionTargetUrlPathScore: 1,
    ...
    averageAgentHiddenCommandShortcutScore: 1,
...
describe("comparison gate checker", () => {
  ...
  it("rejects static reports that drop top-level agent consistency gates", () => {
    const failures = checkComparisonGateReport(staticReport(staticSummary({
      ...
      averagePageCheckUrlItemPathScore: 0.22,
      averagePageCheckFormUrlPathScore: 0.2,
      averagePageCheckActionTargetUrlPathScore: 0.3,
      ...
      averageAgentHiddenCommandShortcutScore: 0.29,
    ...
    expect(failures.map((failure) => failure.message)).toEqual([
      ...
      "averagePageCheckUrlItemPathScore expected >= 0.995, got 0.22",
      "averagePageCheckFormUrlPathScore expected >= 0.995, got 0.2",
      "averagePageCheckActionTargetUrlPathScore expected >= 0.995, got 0.3",
      ...
      "averageAgentHiddenCommandShortcutScore expected >= 0.995, got 0.29",

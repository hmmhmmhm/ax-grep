...
describe("compare-static fixture comparisons", () => {
  it("produces gate-ready agent metrics without browser-backed targets", async () => {
    ...
    expect(report.gateSummary.averageAgentTopResultChoiceShortcutScore).toBe(1);
    expect(report.gateSummary.averageAgentTopReadTargetShortcutScore).toBe(1);
    ...
    expect(report.gateSummary.averageAgentTopQualityShortcutScore).toBe(1);
    expect(report.gateSummary.averageAgentProblemShortcutScore).toBe(1);
    expect(report.gateSummary.averageAgentTopCitationShortcutScore).toBe(1);
    expect(report.gateSummary.averageAgentTopActionShortcutScore).toBe(1);
    ...
    expect(report.gateSummary.averageAgentTopHiddenSignalShortcutScore).toBe(1);
    expect(report.gateSummary.averageAgentHiddenCommandShortcutScore).toBe(1);
    ...
    expect(report.gateSummary.averageAgentSourceSearchProvenanceScore).toBe(1);
    ...
    expect(report.gateSummary.averageAgentPageMetadataShortcutScore).toBe(1);
    ...
    expect(summaryFor(report, "Synthetic source search engine gate")?.agentSourceSearchProvenanceScore).toBe(1);

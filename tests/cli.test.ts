        ...
        semanticSummary: {
          ...
          tableItems: [
            expect.objectContaining({
              ...
              sampleCellRefs: [
                { path: "agent.semanticSummary.tableItems[0].sampleCellRefs[0]", text: "Latency", rowIndex: 2, columnIndex: 1, rowSpan: 2, columnSpan: 2, headers: ["Metric"], selector: "td" },
                { path: "agent.semanticSummary.tableItems[0].sampleCellRefs[1]", text: "120 ms", rowIndex: 2, columnIndex: 3, headers: ["Metric", "Value"], selector: "td:nth-of-type(2)" },
              ],
              selector: "table",
            }),
          ],

...
counts, top role, heading, landmark, named role, direct top semantic entry
paths, interactive description/value/state, link URL, and button description
shortcuts for quick page-shape routing.

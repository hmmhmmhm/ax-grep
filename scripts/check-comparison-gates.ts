...
function checkStaticGate(file: string, summary: GateSummary): GateFailure[] {
  ...
  requireAtLeast(file, failures, "averageAgentNextShortcutScore", summary.averageAgentNextShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentTopReadTargetShortcutScore", summary.averageAgentTopReadTargetShortcutScore, 0.995);
  requireAtLeast(file, failures, "averageAgentResultChoiceScore", summary.averageAgentResultChoiceScore, 0.995);
  requireAtLeast(file, failures, "averageAgentTopResultChoiceShortcutScore", summary.averageAgentTopResultChoiceShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentTopSourceChoiceShortcutScore", summary.averageAgentTopSourceChoiceShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentTopCitationShortcutScore", summary.averageAgentTopCitationShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentPageMetadataShortcutScore", summary.averageAgentPageMetadataShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentTopQualityShortcutScore", summary.averageAgentTopQualityShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentTopFormActionChoiceShortcutScore", summary.averageAgentTopFormActionChoiceShortcutScore, 0.995);
  requireAtLeast(file, failures, "averageAgentHiddenSignalCountScore", summary.averageAgentHiddenSignalCountScore, 0.995);
  requireAtLeast(file, failures, "averageAgentTopHiddenSignalShortcutScore", summary.averageAgentTopHiddenSignalShortcutScore, 0.995);
  requireAtLeast(file, failures, "averageAgentHiddenCommandShortcutScore", summary.averageAgentHiddenCommandShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentTopActionShortcutScore", summary.averageAgentTopActionShortcutScore, 0.995);
  ...
  requireAtLeast(file, failures, "averageAgentStructuredShortcutScore", summary.averageAgentStructuredShortcutScore, 0.995);

...
function summarizeAgent(agent: AgentSummary): Record<string, unknown> {
  return {
    ...
    semanticTopTableFirstOwnedTarget: agent.semanticTopTableFirstOwnedTarget,
    semanticTopTableFirstOwnedRole: agent.semanticTopTableFirstOwnedRole,
    semanticTopTableFirstOwnedName: agent.semanticTopTableFirstOwnedName,
    semanticTopTableFirstOwnedSampleCellText: agent.semanticTopTableFirstOwnedSampleCellText,
    semanticTopTableFirstOwnedSampleCellRowIndex: agent.semanticTopTableFirstOwnedSampleCellRowIndex,
    semanticTopTableFirstOwnedSampleCellColumnIndex: agent.semanticTopTableFirstOwnedSampleCellColumnIndex,
    semanticTopTableFirstOwnedSampleCellOwnedTarget: agent.semanticTopTableFirstOwnedSampleCellOwnedTarget,
